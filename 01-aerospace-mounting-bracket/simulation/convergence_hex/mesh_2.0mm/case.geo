...
// Structured hex convergence case: nx=30 ny=20 nz=2
...
Transfinite Curve {xline1(), xline2(), xline3(), xline4()} = 30;
Transfinite Curve {yline1(), yline2(), yline3(), yline4()} = 20;
Transfinite Curve {zline1(), zline2(), zline3(), zline4()} = 2;

...
// Structured hex convergence case: nx=46 ny=31 nz=3
...
Transfinite Curve {xline1(), xline2(), xline3(), xline4()} = 46;
Transfinite Curve {yline1(), yline2(), yline3(), yline4()} = 31;
Transfinite Curve {zline1(), zline2(), zline3(), zline4()} = 3;

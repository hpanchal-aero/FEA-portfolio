...
// Structured hex convergence case: nx=200 ny=134 nz=14
...
Transfinite Curve {xline1(), xline2(), xline3(), xline4()} = 200;
Transfinite Curve {yline1(), yline2(), yline3(), yline4()} = 134;
Transfinite Curve {zline1(), zline2(), zline3(), zline4()} = 14;

...
// Structured hex convergence case: nx=75 ny=50 nz=5
...
Transfinite Curve {xline1(), xline2(), xline3(), xline4()} = 75;
Transfinite Curve {yline1(), yline2(), yline3(), yline4()} = 50;
Transfinite Curve {zline1(), zline2(), zline3(), zline4()} = 5;

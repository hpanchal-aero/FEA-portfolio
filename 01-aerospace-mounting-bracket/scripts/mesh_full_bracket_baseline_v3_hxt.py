...
def main():
    ...
    gmsh.option.setNumber("Mesh.Algorithm3D", 10)  # HXT algorithm -- same geometry/sizing, different internal numbering
    gmsh.option.setNumber("Mesh.ElementOrder", 2)
    gmsh.option.setNumber("Mesh.Optimize", 0)  # disable Gmsh internal quality optimization pass entirely
